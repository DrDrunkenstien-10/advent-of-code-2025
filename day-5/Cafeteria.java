...
public class Cafeteria {
    ...
    // Part 2
    public static long findFreshIngredientIdsCount(String[] freshIngredientIdRanges) {
        long count = 0;

        List<long[]> ranges = new ArrayList<>();
        for (String r : freshIngredientIdRanges) {
    ...
    public static void main(String[] args) {
        ...
        // String[] availableIngredientIds =
        // readAvailableIngredientIdsFromFile("cafeteria-input.txt");

        long freshIngredientIdsCount = findFreshIngredientIdsCount(freshIngredientIdRanges);
